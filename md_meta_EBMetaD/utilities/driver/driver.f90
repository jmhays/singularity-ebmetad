...
111  format(a6,i5,1x,a4,a1,a3,1x,a1,a4,a1,3x,f8.3,f8.3,f8.3,f6.2,f6.2)
  ...
  if(do_ext) then 
   ...
   if(flag.eq.ncv) then
       ex_frames=ex_frames+1
        ...
        do i=1,nfull
          write (17,111) name(i),num(i),atom(i),altloc(i),residue(i),ics,numres(i),icode(i),x(i),y(i),z(i),occu(i),charge(i)
        enddo
        write(17,'(a3)')"TER"
        write(17,'(a6)')"ENDMDL"
   endif
